> **Superseded on 2026-09-06. Historical design and measurements only.**
> The active [cooperative cancellation plan](selective-isolation-plan.md) replaces
> the separate-Store, custom task, package and invocation-ledger architecture below.
> Its requirements and phase completion claims do not govern new implementation.
