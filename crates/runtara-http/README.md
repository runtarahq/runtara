...
- Declared as a `[workspace.dependencies]` entry (`runtara-http = { path = "crates/runtara-http", version = "4.0" }`) and consumed directly by `runtara-sdk`, `runtara-agents`, `runtara-ai`, and each integration agent crate.
