...
//!
//! This module defines all step type metadata for automatic DSL schema
//! generation. Each step type's metadata is derived from the struct definition
//! using schemars.
//!
...
pub(crate) static STEP_TYPES: &[&StepTypeMeta] = &[
    &FINISH_STEP_META,
    &AGENT_STEP_META,
    &CONDITIONAL_STEP_META,
    &SPLIT_STEP_META,
    &SWITCH_STEP_META,
    &START_WORKFLOW_STEP_META,
    &WHILE_STEP_META,
    &LOG_STEP_META,
    &ERROR_STEP_META,
    &FILTER_STEP_META,
