    ...
    pub mod runtara {
        pub mod workflow_stdlib {
            ...
            pub mod json {
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_agent_scope_input_cabi<T: Guest>(
                    arg0: i32,
                    arg1: *mut u8,
                    arg2: usize,
                    arg3: *mut u8,
                    ...
                    let len0 = arg2;
                    let len1 = arg4;
                    let result2 = T::agent_scope_input(
                        arg0 as u32,
                        _rt::Vec::from_raw_parts(arg1.cast(), len0, len0),
                        _rt::Vec::from_raw_parts(arg3.cast(), len1, len1),
                    );
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn __post_return_agent_scope_input<T: Guest>(arg0: *mut u8) {
                    let l0 = i32::from(*arg0.add(0).cast::<u8>());
                    match l0 {
                        0 => {
                            let l1 = *arg0
                ...
                pub trait Guest {
                    ...
                    /// namespace (`variables._cache_key_prefix`, the same compositional
                    /// formula the EmbedWorkflow path uses). A durable child shares the
                    /// parent instance's checkpoint store; without this scope, its baked
                    /// checkpoint ids collide across invocations and with the parent's.
                    /// Emitted ONLY for workflow-agent targets — native agents receive the
                    /// bare input unchanged.
                ...
                macro_rules! __export_runtara_workflow_stdlib_json_0_1_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        ...
                        * mut u8 { unsafe { $($path_to_types)*::
                        ...
                        (export_name =
                        "runtara:workflow-stdlib/json@0.1.0#agent-scope-input")] unsafe
                        extern "C" fn export_agent_scope_input(arg0 : i32, arg1 : * mut
                        u8, arg2 : usize, arg3 : * mut u8, arg4 : usize,) -> * mut u8 {
                        unsafe { $($path_to_types)*::
                        _export_agent_scope_input_cabi::<$ty > (arg0, arg1, arg2, arg3,
                        arg4) } } #[unsafe (export_name =
                        "cabi_post_runtara:workflow-stdlib/json@0.1.0#agent-scope-input")]
                        unsafe extern "C" fn _post_return_agent_scope_input(arg0 : * mut
                        u8,) { unsafe { $($path_to_types)*::
