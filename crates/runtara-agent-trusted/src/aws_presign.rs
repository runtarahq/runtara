...
mod published_vector {
    ...
    #[test]
    fn matches_aws_published_query_signature() {
        // Public example credentials and expected signature, not live secrets:
