...
use wasm_encoder::{
    ...
    ImportSection, Instruction, MemorySection, MemoryType, Module, Section, TypeSection, ValType,
};
...
use dispatcher::emit_run_plan_mapping;
use mapping::emit_build_source;
