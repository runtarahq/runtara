...
pub fn direct_lowering_tag() -> String {
    ...
    format!(
        "abi={}-v{},durable-delay-parking=v1,cooperative-waits=shared-v11,parent-cancel=v1,loop-cooperation=v1,retry-cooperation=v4,structured-agent-errors=v1,plain-child-errors=v1,omit_runtime={}",
