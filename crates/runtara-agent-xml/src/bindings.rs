    ...
    pub mod runtara {
        pub mod agent_xml {
            ...
            pub mod capabilities {
                ...
                #[doc(hidden)]
                macro_rules! __export_runtara_agent_xml_capabilities_0_3_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[unsafe (export_name =
                        "runtara:agent-xml/capabilities@0.3.0#invoke")] unsafe extern "C"
                        fn export_invoke(arg0 : * mut u8,) -> * mut u8 { unsafe {
                        $($path_to_types)*:: _export_invoke_cabi::<$ty > (arg0) } }
                        #[unsafe (export_name =
                        "cabi_post_runtara:agent-xml/capabilities@0.3.0#invoke")] unsafe
                        extern "C" fn _post_return_invoke(arg0 : * mut u8,) { unsafe {
                        $($path_to_types)*:: __post_return_invoke::<$ty > (arg0) } } };
                    };
                }
                #[doc(hidden)]
                pub(crate) use __export_runtara_agent_xml_capabilities_0_3_0_cabi;
                #[repr(align(8))]
                struct _RetArea(
...
macro_rules! __export_agent_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::runtara::agent_xml::capabilities::__export_runtara_agent_xml_capabilities_0_3_0_cabi!($ty
        with_types_in $($path_to_types_root)*::
        exports::runtara::agent_xml::capabilities);
    };
}
#[doc(inline)]
pub(crate) use __export_agent_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(link_section = "component-type:wit-bindgen:0.41.0:runtara:agent-xml@0.3.0:agent:encoded world")]
#[doc(hidden)]
...
$runtara:agent-xml/capabilities@0.3.0\x05\x03\x04\0\x1druntara:agent-xml/agent@0\
