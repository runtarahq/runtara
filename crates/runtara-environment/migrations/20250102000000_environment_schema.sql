...
-- Version 20250101000000 is reserved by runtara-server's initial schema, so
-- environment migrations start at 20250102000000 to avoid SQLx checksum
-- collisions when both components have used the same database.
