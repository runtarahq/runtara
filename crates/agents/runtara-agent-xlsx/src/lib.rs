...
#[cfg(target_arch = "wasm32")]
use bindings::exports::runtara::agent_xlsx::capabilities::{ConnectionInfo, ErrorInfo, Guest};
...
impl Guest for Component {
    fn invoke(
        ...
        // xlsx itself doesn't take a connection today, but keeping this path
        // identical to the other migrated agents means a future
        // connection-bearing capability needs zero plumbing changes.
