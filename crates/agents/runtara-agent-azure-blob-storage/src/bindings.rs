...
pub mod exports {
    pub mod runtara {
        pub mod agent_azure_blob_storage {
            #[allow(dead_code, async_fn_in_trait, unused_imports, clippy::all)]
            pub mod capabilities {
                ...
                #[doc(hidden)]
                macro_rules! __export_runtara_agent_azure_blob_storage_capabilities_0_3_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[unsafe (export_name =
                        "runtara:agent-azure-blob-storage/capabilities@0.3.0#invoke")]
                        ...
                        "cabi_post_runtara:agent-azure-blob-storage/capabilities@0.3.0#invoke")]
                ...
                #[doc(hidden)]
                pub(crate) use __export_runtara_agent_azure_blob_storage_capabilities_0_3_0_cabi;
                #[repr(align(8))]
                struct _RetArea(
...
macro_rules! __export_agent_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::runtara::agent_azure_blob_storage::capabilities::__export_runtara_agent_azure_blob_storage_capabilities_0_3_0_cabi!($ty
        with_types_in $($path_to_types_root)*::
        exports::runtara::agent_azure_blob_storage::capabilities);
    };
}
#[doc(inline)]
pub(crate) use __export_agent_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(link_section = "component-type:wit-bindgen:0.41.0:runtara:agent-azure-blob-storage@0.3.0:agent:encoded world")]
#[doc(hidden)]
...
\x02\x0dcapability-ids\x05input\x02\0\x03\x04\0\x06invoke\x01\x04\x04\03runtara:\
agent-azure-blob-storage/capabilities@0.3.0\x05\x02\x04\0,runtara:agent-azure-bl\
ob-storage/agent@0.3.0\x04\0\x0b\x0b\x01\0\x05agent\x03\0\0\0G\x09producers\x01\x0c\
