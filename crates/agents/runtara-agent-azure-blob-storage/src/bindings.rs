            ...
            pub mod capabilities {
                ...
                macro_rules! __export_runtara_agent_azure_blob_storage_capabilities_0_3_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        ...
                        { unsafe { $($path_to_types)*:: _export_invoke_cabi::<$ty >
...
3runtara:agent-azure-blob-storage/capabilities@0.3.0\x05\x03\x04\0,runtara:agent\
-azure-blob-storage/agent@0.3.0\x04\0\x0b\x0b\x01\0\x05agent\x03\0\0\0G\x09produ\
