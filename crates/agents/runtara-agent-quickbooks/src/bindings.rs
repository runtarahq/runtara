...
+runtara:agent-quickbooks/capabilities@0.3.0\x05\x03\x04\0$runtara:agent-quickbo\
oks/agent@0.3.0\x04\0\x0b\x0b\x01\0\x05agent\x03\0\0\0G\x09producers\x01\x0cproc\
