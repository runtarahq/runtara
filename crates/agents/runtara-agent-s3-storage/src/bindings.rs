...
agent-s3-storage/capabilities@0.3.0\x05\x02\x04\0$runtara:agent-s3-storage/agent\
@0.3.0\x04\0\x0b\x0b\x01\0\x05agent\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\
