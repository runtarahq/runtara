...
mod bindings {
    ...
    wit_bindgen::generate!({
        ...
        async: ["export:runtara:agent-ai-tools/capabilities@0.4.0#invoke"],
        generate_all,
    });
}
...
impl Guest for Component {
    async fn invoke(capability_id: String, input: Vec<u8>) -> Result<Vec<u8>, ErrorInfo> {
        ...
        let executor_result = match capability_id.as_str() {
            ...
            "chat-completion" => __executor_chat_completion(value).await,
            "chat-turn" => __executor_chat_turn(value).await,
            "summarize-memory" => __executor_summarize_memory(value).await,
            ...
            "embed-text" => __executor_embed_text(value).await,
            other => {
