    ...
    pub mod runtara {
        pub mod agent_compression {
            ...
            pub mod capabilities {
                ...
                #[doc(hidden)]
                macro_rules! __export_runtara_agent_compression_capabilities_0_3_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[unsafe (export_name =
                        "runtara:agent-compression/capabilities@0.3.0#invoke")] unsafe
                        ...
                        * mut u8, arg3 : usize,) -> * mut u8 { unsafe {
                        ...
                        "cabi_post_runtara:agent-compression/capabilities@0.3.0#invoke")]
                ...
                #[doc(hidden)]
                pub(crate) use __export_runtara_agent_compression_capabilities_0_3_0_cabi;
                #[repr(align(8))]
                struct _RetArea(
...
macro_rules! __export_agent_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::runtara::agent_compression::capabilities::__export_runtara_agent_compression_capabilities_0_3_0_cabi!($ty
        with_types_in $($path_to_types_root)*::
        exports::runtara::agent_compression::capabilities);
    };
}
#[doc(inline)]
pub(crate) use __export_agent_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(link_section = "component-type:wit-bindgen:0.41.0:runtara:agent-compression@0.3.0:agent:encoded world")]
#[doc(hidden)]
...
agent-compression/capabilities@0.3.0\x05\x02\x04\0%runtara:agent-compression/age\
