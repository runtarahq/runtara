...
async fn completion_http_preserves_start_label() {
    use base64::Engine;
    ...
    for label in [None, Some(" Order_123 ")] {
        ...
        assert_eq!(record.run_label.as_deref(), label);
        assert_eq!(
