...
import { parseSchema, SchemaField } from '@/features/scenarios/utils/schema';
import { Checkbox } from '@/shared/components/ui/checkbox';
import { FileInput } from '@/shared/components/ui/file-input';
import { CompositeValueEditor } from '@/features/scenarios/components/WorkflowEditor/NodeForm/InputMappingField/CompositeValueEditor';
import type {
  CompositeArrayValue,
...
type ScenarioExecuteDialogProps = {
  open: boolean;
...
export function ScenarioExecuteDialog({
  open,
  onOpenChange,
  scenarioName,
  inputSchema,
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>
            Execute Scenario{scenarioName ? `: ${scenarioName}` : ''}
          </DialogTitle>
          <DialogDescription>
            This scenario requires input data. Please provide the required
            fields below.
          </DialogDescription>
        </DialogHeader>
