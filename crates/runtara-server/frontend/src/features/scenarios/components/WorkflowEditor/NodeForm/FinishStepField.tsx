...
import { inferSchemaFromMapping } from '@/features/scenarios/utils/schema';
      ...
      <div className="flex items-start justify-between gap-2">
        <div>
          ...
          <p className="text-xs text-muted-foreground">
            {hasSchemaFields
              ? 'Map scenario variables to output fields defined in the scenario schema.'
              : 'Map scenario variables into the final output payload.'}
          </p>
        </div>
      </div>
              ...
              <tr>
                ...
                >
                  {hasSchemaFields
                    ...
                    : 'No outputs yet. Add an output to expose data from the scenario.'}
                </td>
              </tr>
            )}
          </tbody>
