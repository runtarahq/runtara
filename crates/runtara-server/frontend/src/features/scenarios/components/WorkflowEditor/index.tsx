...
import {
  SNAP_GRID_SIZE,
  snapPositionToGrid,
} from '@/features/scenarios/config/workflow-editor.ts';
import {
  validateConnection,
  getDownstreamNodes,
} from '@/features/scenarios/utils/graph-validation';
import { ExecutionGraphStepDto } from '@/features/scenarios/types/execution-graph';
...
export function WorkflowEditor({
  ...
  // Center viewport on virtual start step for new/empty scenarios
  useEffect(() => {
    ...
    <>
      ...
      {editingNodeData && scenario && (
        <NodeConfigDialog
          ...
          outputSchemaFields={scenario.outputSchemaFields}
          inputSchemaFields={scenario.inputSchemaFields}
