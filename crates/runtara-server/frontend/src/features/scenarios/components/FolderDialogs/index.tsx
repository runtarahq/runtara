      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            {scenarioCount > 0 ? (
              <>
                This folder contains {scenarioCount} scenario
                {scenarioCount !== 1 ? 's' : ''}. Deleting the folder will move
                all scenarios to the root level. This action cannot be undone.
              </>
            ) : (
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Move "{scenarioName}" to a different folder.
          </DialogDescription>
        </DialogHeader>
