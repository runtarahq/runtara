...
interface TimelineState {
  ...
  // Instance tracking (to reset when scenario or instance changes)
...
export const useTimelineStore = create<TimelineState>()(
  devtools(
    immer((set) => ({
      ...
      setCurrentInstance: (scenarioId, instanceId) => {
        set((state) => {
          // Reset everything when scenario or instance changes
          if (
