...
const meta: Meta<typeof BasicNode> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Basic node used for most step types: Agent, Finish, EmbedWorkflow, etc. Has target, source, and optional onError handles.',
      },
    },
  },
  tags: ['autodocs'],
...
// EmbedWorkflow step
export const EmbedWorkflowStep: Story = {
...
// During workflow execution (read-only mode)
...
export const StepTypesGallery: Story = {
  ...
  render: () => {
    const stepTypes = [
      ...
      { type: 'EmbedWorkflow', name: 'Start Workflow' },
