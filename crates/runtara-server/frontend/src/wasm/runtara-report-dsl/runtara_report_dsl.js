 ...
 * @returns {boolean}
 */
export function evaluateRowCondition(expr, row) {
    const ret = wasm.evaluateRowCondition(expr, row);
    if (ret[2]) {
...
export function formatValue(value, format, ctx) {
    ...
    try {
        ...
        const ret = wasm.formatValue(value, ptr0, len0, ctx);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
...
export function renderTemplate(template, row, ctx) {
    ...
    try {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.renderTemplate(ptr0, len0, row, ctx);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg___runtaraReportDslFormatValue_f28e386a1b4c133a = function(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9) {
        const ret = window.__runtaraReportDslFormatValue(arg1, getStringFromWasm0(arg2, arg3), getStringFromWasm0(arg4, arg5), getStringFromWasm0(arg6, arg7), getStringFromWasm0(arg8, arg9));
        const ptr1 = passStringToWasm0(ret, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        getDataViewMemory0().setInt32(arg0 + 4 * 1, len1, true);
        getDataViewMemory0().setInt32(arg0 + 4 * 0, ptr1, true);
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('runtara_report_dsl_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
