...
impl SmoMcpServer {
    ...
    #[tool(
        description = "Get the canonical report authoring schema for MCP agents, including table/chart/metric/action block shapes, Object Model sources, workflow runtime sources, and common mistakes. Optionally pass object_schema to include Object Model fields."
    )]
