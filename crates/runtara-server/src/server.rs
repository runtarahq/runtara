...
#[openapi(
    ...
    components(
        schemas(
            ...
            runtara_report_dsl::ReportMetricRowLayoutNode,
            runtara_report_dsl::ReportSectionLayoutNode,
            runtara_report_dsl::ReportColumnsLayoutNode,
            runtara_report_dsl::ReportLayoutColumn,
