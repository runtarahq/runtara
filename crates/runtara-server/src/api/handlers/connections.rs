...
use crate::api::services::connections::{ConnectionService, ServiceError};
        ...
        .await
    {
        Ok(mut connections) => {
            ...
            if params.include_rate_limit_stats && !connections.is_empty() {
                ...
                // Validate interval
                if let Err(crate::api::services::rate_limits::ServiceError::DatabaseError(msg)) =
...
use crate::api::dto::connections::{
    ConnectionAuthType, ConnectionAuthTypeDto, ConnectionCategory, ConnectionCategoryDto,
    ConnectionFieldDto, ConnectionTypeDto, ConnectionTypeResponse, ListConnectionAuthTypesResponse,
    ListConnectionCategoriesResponse, ListConnectionTypesResponse, OAuthConfigDto,
};
use crate::api::utils::rate_limit_defaults::get_default_rate_limit_config;
