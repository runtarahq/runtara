...
- Consumed exclusively by `runtara-server`, which mounts the two routers (`connections_router`, `oauth_callback_router`) and holds an `Arc<ConnectionsFacade>` in `AppState`.
